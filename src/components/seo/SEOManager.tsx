...
export default function SEOManager({
	...
	const formattedTitle = title.includes("LaunchVeda")
		? title
		: `${title} | LaunchVeda`;
	...
	const canonicalId = canonical.includes("#")
		? canonical
		: `${canonical}#webpage`;
	...
	if (service) {
		renderedSchemas.push({
			...
			audience: {
				"@type": "Audience",
				audienceType:
					"Founders, startups, product businesses, D2C brands and creators launching physical product brands",
			},
	...
	if (organization) {
		...
		orgSchema.description =
			...
			"LaunchVeda is India’s No.1 Product Launch Company helping founders launch Perfume, Cosmetic, Ayurveda, and Nutraceutical brands with end-to-end support.";
			...
			if (organization.email) {
				orgSchema.contactPoint = {
					...
					...(organization.telephone
						...
						: {}),
					...(organization.contactOption
						? { contactOption: organization.contactOption }
						: {}),
	...
	return (
		<>
			...
			<meta
				...
				content="c3a2be20dd296803c470ef39dc0fb8a5"
			/>
