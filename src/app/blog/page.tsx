  ...
  return (
    <div className="bg-white min-h-screen flex flex-col">
      <SEOManager
        ...
        description="Insights and guides on launching a brand in India."
        canonical="https://launchveda.com/blog"
        breadcrumb={[
          { name: "Home", item: "https://launchveda.com" },
          { name: "Blog & Knowledge Hub", item: "https://launchveda.com/blog" }
        ]}
        service={{
          name: "Blog & Knowledge Hub",
          description: "Insights and guides on launching a brand in India."
        }}
      />
      ...
      <main className="flex-grow pt-32 pb-24 px-4 sm:px-12 max-w-[1200px] mx-auto w-full">
        ...
        <section className="mb-16">
          <GsapTextReveal as="h1" variant="heading" className="text-4xl sm:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight">Blog & Knowledge Hub</GsapTextReveal>
          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-xl shadow-sm mb-8">
            ...
            <GsapTextReveal as="p" variant="subheading" className="text-slate-700 leading-relaxed text-lg">Insights and guides on launching a brand in India. LaunchVeda provides a complete, step-by-step connected ecosystem to take your idea from formulation to successful market launch, ensuring compliance, premium quality, and scalable growth.</GsapTextReveal>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <GsapTextReveal as="p" variant="subheading" className="text-slate-600 leading-relaxed text-lg">Launching a product brand requires expertise across multiple domains. Our Blog & Knowledge Hub service connects you with vetted experts, state-of-the-art facilities, and advanced growth strategies. We eliminate the guesswork so you can focus on building your brand's vision.</GsapTextReveal>
        </section>
