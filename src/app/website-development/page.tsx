    ...
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-32 pb-24 px-4 sm:px-12 max-w-[1200px] mx-auto w-full">
        ...
        <section className="mb-16">
          <GsapTextReveal as="h1" variant="heading" className="text-4xl sm:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight">Website Development</GsapTextReveal>
