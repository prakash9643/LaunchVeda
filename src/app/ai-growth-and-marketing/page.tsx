    ...
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-32 pb-24 px-4 sm:px-12 max-w-[1200px] mx-auto w-full">
        ...
        <section className="mb-16">
          <GsapTextReveal as="h1" variant="heading" className="text-4xl sm:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight">AI Growth & Marketing</GsapTextReveal>
        ...
        <section className="mb-16">
          ...
          <GsapTextReveal as="p" variant="subheading" className="text-slate-600 leading-relaxed text-lg">Launching a product brand requires expertise across multiple domains. Our AI Growth & Marketing service connects you with vetted experts, state-of-the-art facilities, and AI-driven growth strategies. We eliminate the guesswork so you can focus on building your brand's vision.</GsapTextReveal>
        </section>
            ...
            <ol className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <GsapTextReveal as="p" variant="text" className="text-slate-600 text-sm">Marketplace optimization and AI-powered growth campaigns.</GsapTextReveal>
                </div>
              </li>
            </ol>
          </section>
