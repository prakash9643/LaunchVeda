    ...
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-32 pb-24 px-4 sm:px-12 max-w-[1200px] mx-auto w-full">
        ...
        <section className="mb-16">
          <GsapTextReveal as="h1" variant="heading" className="text-4xl sm:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight">Product Formulation</GsapTextReveal>
          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-xl shadow-sm mb-8">
            ...
            <GsapTextReveal as="p" variant="subheading" className="text-slate-700 leading-relaxed text-lg">Expert product formulation for cosmetics, ayurveda, and nutraceuticals. LaunchVeda provides a complete, step-by-step connected ecosystem to take your idea from formulation to successful market launch, ensuring compliance, premium quality, and scalable growth.</GsapTextReveal>
          </div>
        </section>
