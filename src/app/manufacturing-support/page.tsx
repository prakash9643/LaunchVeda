    ...
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-32 pb-24 px-4 sm:px-12 max-w-[1200px] mx-auto w-full">
        ...
        <section className="mb-16">
          <GsapTextReveal as="h1" variant="heading" className="text-4xl sm:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-xl shadow-sm mb-8">
            ...
            <GsapTextReveal as="p" variant="subheading" className="text-slate-700 leading-relaxed text-lg">
              Reliable manufacturing support for your product brand. LaunchVeda provides a complete, step-by-step connected ecosystem to take your idea from formulation to successful market launch, ensuring compliance, premium quality, and scalable growth.
            </GsapTextReveal>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <GsapTextReveal as="p" variant="subheading" className="text-slate-600 leading-relaxed text-lg">
            Launching a product brand requires expertise across multiple domains. Our Manufacturing Support service connects you with vetted experts, state-of-the-art facilities, and advanced growth strategies. We eliminate the guesswork so you can focus on building your brand's vision.
          </GsapTextReveal>
        </section>
            ...
            <ol className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <GsapTextReveal as="p" variant="text" className="text-slate-600 text-sm">Marketplace optimization and advanced growth campaigns.</GsapTextReveal>
                </div>
              </li>
            </ol>
          </section>
